...
def process_muscle_up_video(video_path, height_cm, weight_kg, start_time=1.0, output_video_path='output_video.mp4'):
    ...
    df.to_csv('velocity_data.csv', index=False)  # 保存为 CSV
...
if __name__ == "__main__":
    video_path = 'D:/Users/G122/PycharmProjects/pythonProject6/Mu/Mu_in.mp4'
    height_cm = 173  # 替换为你的身高（厘米）
    weight_kg = 64   # 替换为你的体重（千克）
    output_video_path = 'D:/Users/G122/PycharmProjects/pythonProject6/Mu/6_vertical_muscleups_analysis.mp4'
    print("视频已保存")
